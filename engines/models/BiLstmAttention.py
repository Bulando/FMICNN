...
class BiLSTMAttention(object):
    def __init__(self, config, wordEmbedding):
        ...
        print("dropoutKeepProb:", self.dropoutKeepProb)
        # 词嵌入层
        with tf.name_scope("embedding"):
            ...
            self.embeddedWords = wordEmbedding
            print("embeddedWords:", self.embeddedWords)
        # 定义两层双向LSTM的模型结构
            ...
            for idx, hiddenSize in enumerate(self.config.model.hiddenSizes):
                with tf.name_scope("Bi-LSTM" + str(idx)):
                    ...
                    lstmFwCell = tf.compat.v1.nn.rnn_cell.DropoutWrapper(
                        tf.compat.v1.nn.rnn_cell.LSTMCell(num_units=hiddenSize, state_is_tuple=True),
                    ...
                    outputs_, self.current_state = tf.compat.v1.nn.bidirectional_dynamic_rnn(lstmFwCell, lstmBwCell,
    ...
    def attention(self, H):
        ...
        # 初始化一个权重向量，是可训练的参数
        W = tf.Variable(tf.compat.v1.random_normal([hiddenSize], stddev=0.1))
